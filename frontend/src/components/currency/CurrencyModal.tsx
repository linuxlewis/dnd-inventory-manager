        ...
        <div className="relative w-full max-w-md bg-gray-800 rounded-lg shadow-xl">
          ...
          <div className="flex justify-end gap-3 p-4 border-t border-gray-700 bg-gray-900 rounded-b-lg">
            ...
            <button
              ...
              className={`px-4 py-2 text-white rounded-lg transition-colors disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 ${
                isSpendMode
